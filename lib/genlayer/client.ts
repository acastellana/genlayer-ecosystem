...
export const GENLAYER_NETWORK = {
  ...
  rpcUrls: [process.env.NEXT_PUBLIC_GENLAYER_RPC_URL || "https://zksync-os-testnet-genlayer.zksync.dev"],
...
export function getStudioUrl(): string {
  return (
    process.env.NEXT_PUBLIC_GENLAYER_RPC_URL || "https://zksync-os-testnet-genlayer.zksync.dev"
  );
}
